# WidgetWeaver roadmap

This repository ships WidgetWeaver: a WidgetKit-first editor that builds real widgets using a context-aware tool suite.

Primary roadmap documents:

- `Docs/ROADMAP_Q1_2026.md` — what we are building, why, and when.
- `Docs/ROADMAP_AI_2026-01.md` — AI engine roadmap (reviewable spec authoring; in-cycle track).
