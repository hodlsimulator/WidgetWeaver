...
- [ ] Removing “Reading” from Explore does not break existing user widgets.
...
- [ ] Disable/re-enable permissions relevant to a template (Calendar/Health) and confirm messaging.
...
- [ ] Privacy labels and permissions strings are accurate.
...
1) Any new Photo template variants beyond the minimum.
2) Noise Machine upgrades beyond responsiveness and basic controls.
3) Variables improvements beyond “discoverable + insertable”.
4) Any Weather work.
5) Any AI work.
