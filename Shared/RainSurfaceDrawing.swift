...
enum RainSurfaceDrawing {
    ...
    private static func drawFuzz(
        ...
        // Controls how quickly fuzz ramps up as certainty falls.
        // 1.0 = linear; 2.0 = stronger ramp (more contrast between smooth vs fuzzy).
        ...
        if maxFuzzStrength <= 0.0005 { return }
