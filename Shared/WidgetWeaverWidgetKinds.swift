...
public enum WidgetWeaverWidgetKinds {
    ...
    // Bumped to force a clean WidgetKit archive when the clock gets stuck / partially rendered.
    public static let homeScreenClock = "WidgetWeaverHomeScreenClockWidgetV3"
}
