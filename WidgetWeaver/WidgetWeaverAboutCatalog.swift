...
extension WidgetWeaverAboutView {
    ...
    static let starterTemplatesAll: [WidgetWeaverAboutTemplate] = [
        ...
        WidgetWeaverAboutTemplate(
            ...
            title: "Today",
            subtitle: "Reminders",
            description: "When Smart Stack v2 is enabled: due today (by local day).",
        ...
        WidgetWeaverAboutTemplate(
            ...
            title: "Overdue",
            subtitle: "Reminders",
            description: "When Smart Stack v2 is enabled: due before today (by local day).",
        ...
        WidgetWeaverAboutTemplate(
            ...
            title: "Upcoming",
            subtitle: "Reminders",
            description: "When Smart Stack v2 is enabled: due tomorrow through the next 7 days (never Today).",
        ...
        WidgetWeaverAboutTemplate(
            ...
            title: "High priority",
            subtitle: "Reminders",
            description: "When Smart Stack v2 is enabled: priority 1–4 reminders not already shown in Overdue, Today, or Upcoming.",
        ...
        WidgetWeaverAboutTemplate(
            ...
            title: "Anytime",
            subtitle: "Reminders",
            description: "When Smart Stack v2 is enabled: reminders with no due date (excluding anything already shown above).",
        ...
        WidgetWeaverAboutTemplate(
            ...
            title: "Lists",
            subtitle: "Reminders",
            description: "When Smart Stack v2 is enabled: the remainder only — reminders not already shown in the other pages, grouped by list (never repeats items already shown).",
