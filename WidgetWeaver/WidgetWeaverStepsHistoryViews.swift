//
//  WidgetWeaverStepsHistoryViews.swift
//  WidgetWeaver
//
//  Created by . . on 12/21/25.
//
//  Extracted from WidgetWeaverStepsSettingsView.swift to keep the settings screen focused.
//
//  History: timeline + calendar + heatmap views.
//
...
struct WidgetWeaverStepsHistoryView: View {
